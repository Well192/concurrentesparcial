...
public class TCPServer50 {
    ...
    public void sendMessageTCPServerRango(String polinomio, int a,int b, int cantidad){
        ...
        for (int i = 1; i < nrcli; i++) {
            ...
            sendclis[i].sendMessage("evalua " + polinomio +" "+((i-1) * d + a) + " " + ((i-1) * d + d + a) + " " +cantidad+" "+Rango);

            System.out.println("ENVIANDO A JUGADOR " + (i)+" -> "+polinomio +" "+((i-1) * d + a) + " " + ((i-1) * d + d + a) + " " +cantidad+" "+Rango);

        }

        sendclis[nrcli].sendMessage("evalua " + polinomio+ " "+ ((d * (nrcli - 1))+a) + " " + (b) + " " + cantidad+" "+Rango);

        System.out.println("ENVIANDO A JUGADOR " + (nrcli)+" -> "+ polinomio+ " "+ ((d * (nrcli - 1))+a) + " " + (b) + " " + cantidad+" "+ Rango);
